...
<p className='font-medium text-base text-blue-950 relative left-24 top-16 '>Home Shop <span className='text-pink-700'> . Product Details</span></p>
      ...
      <div></div> 
      <div className='bg-[#ffffff] w-[1170px] h-[509px]  pt-16'>
<div className='ml-20 flex flex-col space-y-4'>
 ...
 <Image src={'/bag4.png'} alt='hand bag'  width={375} height={487} className='flex relative bottom-[490px] ml-64 '/>
   ...
   <h1 className='text-blue-900 flex flex-col space-y-4 text-3xl pb-2 pt-20'>Playwood arm chair</h1>
    ...
    <div className='flex gap-4 text-[20px] ml-10 pb-3 text-blue-800'>Add To cart <p className='pt-2'> <CiHeart /></p></div>
    <p className='pb-3 text-blue-800'>Categories:</p>
    <p className='pb-3  text-blue-800'>Tags</p>
   <div className='flex gap-4  text-blue-800'>Share <p className='gap-4 flex pt-1'><FaFacebook /> <PiInstagramLogoFill /> <FaSquareTwitter /></p></div>
      </div>
      

      <div className='w-[1000px] h-[500px] bg-[#F9F8FE] relative bottom-64'>
        ...
        <p className='text-gray-400 text-sm ml-20 pt-4'>Aliquam dis vulputate vulputate integer sagittis. Faucibus dolor ornare faucibus vel sed et eleifend habitasse amet. Montes, mauris varius ac est bibendum.<br></br> Scelerisque a, risus ac ante. Velit consectetur neque, elit, aliquet. Non varius proin sed urna, egestas consequat laoreet diam tincidunt. Magna eget faucibus<br></br> cras justo, tortor sed donec tempus. Imperdiet consequat, quis diam arcu, nulla lobortis justo netus dis. Eu in fringilla vulputate nunc nec. Dui, massa viverr .</p>
       <h4 className='pt-8 text-1xl text-blue-900 gap-5 ml-20 font-bold '>More details</h4>
       
        <p className=' flex text-gray-400 text-sm ml-20 pt-4 gap-3'>< FaArrowRight className='flex text-black '/>Aliquam dis vulputate vulputate integer sagittis. Faucibus ds diam arcu, nulla lobortis justo netus dis. Eu in fringilla vulputate nunc nec. Dui, massa viverr .</p>
        <p className=' flex text-gray-400 text-sm ml-20 pt-4 gap-3'>< FaArrowRight className='flex text-black '/>Aliquam dis vulputate vulputate integer sagittis. Faucibus ds diam arcu, nulla lobortis justo netus dis. Eu in fringilla vulputate nunc nec. Dui, massa viverr .</p>
        <p className=' flex text-gray-400 text-sm ml-20 pt-4 gap-3'>< FaArrowRight className='flex text-black '/>Aliquam dis vulputate vulputate integer sagittis. Faucibus ds diam arcu, nulla lobortis justo netus dis. Eu in fringilla vulputate nunc nec. Dui, massa viverr .</p>
        <p className=' flex text-gray-400 text-sm ml-20 pt-4 gap-3'>< FaArrowRight className='flex text-black '/>Aliquam dis vulputate vulputate integer sagittis. Faucibus ds diam arcu, nulla lobortis justo netus dis. Eu in fringilla vulputate nunc nec. Dui, massa viverr .</p>
      </div>
...
<div className='relative bottom-44'>
      ...
      <Props5 Image1='/d4.png' name='Top Wall Digital Clock' Image2='/5stars.png' price='$51.00' /></div>
