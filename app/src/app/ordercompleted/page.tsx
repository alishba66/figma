...
<p className='font-medium text-base text-blue-950 relative left-24 top-16 '>Home Shop <span className='text-pink-700'> Order Completed</span></p>
      ...
      <p className='text-sm text-gray-400 '>Thank you for your order! Your order is being processed and will be completed within 3-6</p>
        <p className='text-sm text-gray-400 ml-10 pb-5 '>hours. You will receive an email confirmation when your order is completed.
</p>

<button className='w-[208px] h-[59px] bg-[#FB2E86] text-white text-center ml-40 '>Continue Shopping</button>
      </div>
      <Image src={'/checklist.png'} alt='chechlist' width={70} height={70} className=' relative left-[800px] bottom-6'/>
